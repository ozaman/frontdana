                ...
                headers: {'Content-Type': 'application/x-www-form-urlencoded'}
                  ...
                  console.log("====================")
                    ...
                    console.log($scope.tours)
                     $scope.iframe = {navilink:res[0].map};
                      console.log($scope.iframe)
                      $scope.link = "https://maps.google.com/maps?q="+res[0].map+"&hl=es;z=14&amp;output=embed"
                      console.log( $scope.link)
                    console.log($scope.tours.background.split('\r\n'))
                    angular.forEach(res, function (d,i) {
                    if (d.show_re == 1 ) {
