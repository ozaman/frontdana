    ...
    <body class="ecommerce-page" ng-app="myApp" ng-controller="view"> 
      ...
      <!-- navbar-fixed-top -->
        ...
        <div class="container-fluid" style="">
                            <!--  background-image: url(files/images/bg-wrap.jpg);-->
            <div class="row" >                        
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div style=" margin-top: 70px;  background: rgba(255, 255, 255, 0.36);  padding: 15px 3px;    border-radius: 8px; margin-bottom: 20px;" >
                    ...
                    <div style=" margin-top: 70px;  background: rgba(255, 255, 255, 0.36);  padding: 15px 3px;    border-radius: 8px; margin-bottom: 20px;" ></div>
                </div>
            </div>
        </div>
